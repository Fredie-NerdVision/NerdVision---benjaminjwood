...
<section class="section" id="services">
	<div class="shell">
		<div class="section-head reveal">
			<span class="mono"><?php esc_html_e( 'What I Offer', 'bjw-studio' ); ?></span>
			<h2><?php esc_html_e( 'Comprehensive Audio Services', 'bjw-studio' ); ?></h2>
		</div>
			...
			<?php foreach ( $bjw_services as $bjw_service ) : ?>
				<article class="strip reveal">
					<div class="strip__head">
						<span class="strip__id"><?php echo esc_html( $bjw_service['id'] ); ?></span>
						<span class="strip__knob" aria-hidden="true"></span>
					</div>
					<h4><?php echo esc_html( $bjw_service['title'] ); ?></h4>
					<div class="strip__fader" aria-hidden="true"><i style="width:<?php echo esc_attr( $bjw_service['level'] ); ?>%"></i></div>

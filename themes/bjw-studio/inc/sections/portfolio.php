...
$bjw_works = array(
	array(
		'tag'   => __( 'Clip 01', 'bjw-studio' ),
		'title' => __( 'The Last Signal', 'bjw-studio' ),
		'meta'  => __( 'Film Score - Orchestral & Synth', 'bjw-studio' ),
		'peaks' => array( 12, 26, 18, 34, 22, 38, 16, 30, 24, 14, 32, 20, 28, 18, 36, 22, 12, 26 ),
	),
	array(
		'tag'   => __( 'Clip 02', 'bjw-studio' ),
		'title' => __( "Echoes of K'lar", 'bjw-studio' ),
		'meta'  => __( 'Video Game Soundtrack', 'bjw-studio' ),
		'peaks' => array( 20, 14, 30, 22, 36, 18, 28, 12, 34, 24, 16, 32, 20, 38, 14, 26, 22, 18 ),
	),
);
?>
<section class="section" id="portfolio">
	<div class="shell">
		<div class="section-head reveal">
			<span class="mono"><?php esc_html_e( 'Selected Work', 'bjw-studio' ); ?></span>
			<h2><?php esc_html_e( 'My Portfolio Highlights', 'bjw-studio' ); ?></h2>
		</div>

		<div class="clips">
			<?php foreach ( $bjw_works as $bjw_work ) : ?>
				<a class="clip reveal" href="#">
					<span>
						<span class="clip__tag"><?php echo esc_html( $bjw_work['tag'] ); ?></span>
					...
					<span>
						...
						<span class="clip__bars" aria-hidden="true">
							<?php foreach ( $bjw_work['peaks'] as $bjw_peak ) : ?>

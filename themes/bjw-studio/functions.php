...
define( 'BJW_THEME_SLUG', 'bjw-studio' );
...
function bjw_setup() {
	...
	register_nav_menus(
		array(
			'primary' => __( 'Primary Menu', 'bjw-studio' ),
		)
	);
}
...
function bjw_assets() {
	...
	wp_enqueue_style(
		'bjw-fonts',
		'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500&family=JetBrains+Mono:wght@400;500&family=Space+Grotesk:wght@500;600;700&display=swap',
		array(),
		null
	);

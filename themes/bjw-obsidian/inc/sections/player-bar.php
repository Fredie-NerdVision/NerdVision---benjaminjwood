 ...
 */
?>
<div class="player" role="region" aria-label="<?php esc_attr_e( 'Audio player', 'bjw-obsidian' ); ?>">
	<div class="player__inner">
		...
		<div class="player__controls">
			<button type="button" class="icon-btn" data-player-prev aria-label="<?php esc_attr_e( 'Previous track', 'bjw-obsidian' ); ?>">
			...
			<button type="button" class="icon-btn icon-btn--play" data-player-play aria-label="<?php esc_attr_e( 'Play', 'bjw-obsidian' ); ?>">
			...
			<button type="button" class="icon-btn" data-player-next aria-label="<?php esc_attr_e( 'Next track', 'bjw-obsidian' ); ?>">
		...
		<div class="player__timeline">
			...
			<div class="scrub" data-player-scrub role="slider" tabindex="0" aria-label="<?php esc_attr_e( 'Seek', 'bjw-obsidian' ); ?>" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">

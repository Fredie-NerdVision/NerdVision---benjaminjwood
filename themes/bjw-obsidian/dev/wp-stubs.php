...
function wp_head() {
	...
	echo '<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600&family=Montserrat:wght@300;400;500;600&display=swap">' . "\n";
	echo '<link rel="stylesheet" href="/assets/css/theme.css">' . "\n";
	echo '<style>' . bjw_marble_variables() . '</style>' . "\n";
}
